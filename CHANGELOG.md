...
Release notes are maintained per crate and generated by release-plz:

- [`tower-mcp`](crates/tower-mcp/CHANGELOG.md)
- [`tower-mcp-types`](crates/tower-mcp-types/CHANGELOG.md)
- [`tower-mcp-macros`](crates/tower-mcp-macros/CHANGELOG.md)

The entries below are historical (through 0.7.0), from before the workspace moved
to per-crate changelogs. They are kept for reference.
