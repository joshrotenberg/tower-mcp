...
use super::*;
use crate::transport::origin::is_localhost_host;
...
/// Validate the `Origin` header against this transport's policy.
///
/// See [`crate::transport::origin::validate_origin`].
fn validate_origin(headers: &HeaderMap, state: &AppState) -> Option<Response> {
    crate::transport::origin::validate_origin(
        headers,
